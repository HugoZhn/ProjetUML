...
public class Participant {
    ...
    public Participant(int noInscr, Vehicule vehiculeUtilise, Edition editionParticipe, Coureur coureurParticipant, boolean isValide) {
    ...
    public boolean isInscrValidee(){
        return this.inscrValidee;
    }
